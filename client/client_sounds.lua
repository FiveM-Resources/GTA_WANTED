...
------
RegisterNetEvent('GTA_WANTED:PlayOnOne')
AddEventHandler('GTA_WANTED:PlayOnOne', function(soundFile, soundVolume)
    SendNUIMessage({
...
------
RegisterNetEvent('GTA_WANTED:PlayOnAll')
...
------
RegisterNetEvent('GTA_WANTED:PlayWithinDistance')
AddEventHandler('GTA_WANTED:PlayWithinDistance', function(playerNetId, maxDistance, soundFile, soundVolume)
...
------
-- RegisterNetEvent LIFE_CL:Sound:PlayWithinDistanceOS (Bigmode varient of GTA_WANTED:PlayWithinDistance)
--
...
-- @TODO Change sound volume based on the distance the player is away from the playOnEntity.
------
RegisterNetEvent('GTA_WANTED:PlayWithinDistanceOS')
AddEventHandler('GTA_WANTED:PlayWithinDistanceOS', function(playerCoords, maxDistance, soundFile, soundVolume)
    local lCoords = GetEntityCoords(GetPlayerPed(-1))
