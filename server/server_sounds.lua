...
------
-- RegisterServerEvent GTA_WANTED:PlayOnOne
-- Triggers -> ClientEvent GTA_WANTED:PlayOnOne
--
...
------
RegisterServerEvent('GTA_WANTED:PlayOnOne')
AddEventHandler('GTA_WANTED:PlayOnOne', function(clientNetId, soundFile, soundVolume)
    TriggerClientEvent('GTA_WANTED:PlayOnOne', clientNetId, soundFile, soundVolume)
end)

------
-- RegisterServerEvent GTA_WANTED:PlayOnSource
-- Triggers -> ClientEvent GTA_WANTED:PlayOnSource
--
-- @param soundFile    - The name of the soundfile within the client/html/sounds/ folder.
--                     - Can also specify a folder/sound file.
-- @param soundVolume  - The volume at which the soundFile should be played. Nil or don't
...
------
RegisterServerEvent('GTA_WANTED:PlayOnSource')
AddEventHandler('GTA_WANTED:PlayOnSource', function(soundFile, soundVolume)
    local source = source 
    TriggerClientEvent('GTA_WANTED:PlayOnOne', source, soundFile, soundVolume)
end)

------
-- RegisterServerEvent GTA_WANTED:PlayOnAll
-- Triggers -> ClientEvent GTA_WANTED:PlayOnAll
--
-- @param soundFile     - The name of the soundfile within the client/html/sounds/ folder.
--                      - Can also specify a folder/sound file.
-- @param soundVolume   - The volume at which the soundFile should be played. Nil or don't
...
------
RegisterServerEvent('GTA_WANTED:PlayOnAll')
AddEventHandler('GTA_WANTED:PlayOnAll', function(soundFile, soundVolume)
    TriggerClientEvent('GTA_WANTED:PlayOnAll', -1, soundFile, soundVolume)
end)

------
-- RegisterServerEvent GTA_WANTED:PlayWithinDistance
-- Triggers -> ClientEvent GTA_WANTED:PlayWithinDistance
--
...
------
RegisterServerEvent('GTA_WANTED:PlayWithinDistance')
AddEventHandler('GTA_WANTED:PlayWithinDistance', function(maxDistance, soundFile, soundVolume)
    TriggerClientEvent('GTA_WANTED:PlayWithinDistance', -1, source, maxDistance, soundFile, soundVolume)
end)
